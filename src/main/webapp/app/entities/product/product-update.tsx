    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="shopApp.product.home.createOrEditLabel">Create or edit a Product</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : productEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="img_urlLabel" for="product-img_url">
                    Img Url
                  </Label>
                  <AvField id="product-img_url" type="text" name="img_url" />
                </AvGroup>
                <AvGroup>
                  <Label id="commentLabel" for="product-comment">
                    Comment
                  </Label>
